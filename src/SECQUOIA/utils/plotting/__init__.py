...
from SECQUOIA.utils.plotting.row_render import (
    ...
    _reset_plot_widget,
    _reset_row_y_axis,
    _resolve_row_channel,
    _resolve_row_column,
    _resolve_row_mask_index,
    _row_axis_metrics,
    _row_curve_plan,
    _row_xmax,
    _RowColumn,
...
def _ensure_selection_dicts(main_window) -> None:
    """Create the per row selection dicts on first use."""
